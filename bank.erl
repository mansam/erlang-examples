% bank.erl
% Author: Sam Lucidi
% Model a simple representation of a bank.
%
% All function calls return a tuple containing
% a status message and a more detailed result.
%
% In the case of a success, the tuple with be of the form:
% 	{ok, Result} for non mutatitive queries, or, 
%	{ok, NewBank} for calls that manipulate the bank.
% In the event of a failure, the tuple will be of the form:
